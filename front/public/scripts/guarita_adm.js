...
async function exibirRotas(rotas) {
    ...
    await rotas.forEach(rota => {
        ...
        containerButton.classList.add('botoes');
        
        // Criar o botão "Monitorar"
        ...
        containerButton.appendChild(btnEditar);

        // Adicionar os elementos criados à caixa
        ...
        // Adicionar a caixa ao container principal
